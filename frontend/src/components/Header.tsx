export function Header() {
  return (
    <div className="flex items-center justify-between mb-6">
      <div>
        <h1 className="text-3xl font-extrabold text-ink-900">Development Board</h1>
  ...
  return (
    <div className="flex items-center justify-between px-6 py-3 border-b border-ink-300/40 bg-canvas">
      <div className="flex-1 max-w-2xl">
        <div className="bg-white border border-ink-300/50 rounded-full px-4 py-2 text-sm text-ink-500 flex items-center gap-2">
          <span>🔍</span>
          <span>Search tasks, sessions, or IDs...</span>
        </div>
      </div>
